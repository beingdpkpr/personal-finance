      ...
      {view === 'monthly' ? (
        <>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:14 }}>
            {[
              { label:'Monthly Income',  value: fmt(income),      color:'var(--positive)', icon:'↑' },
              { label:'Monthly Spending',value: fmt(expense),     color:'var(--negative)', icon:'↓' },
              { label:'Net Saved',       value: fmt(savings),     color: savings>=0?'var(--positive)':'var(--negative)', icon:'💰' },
